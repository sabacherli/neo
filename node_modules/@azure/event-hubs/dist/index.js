    ...
    const obj = {
        ...
        async connect({ abortSignal, timeoutInMs }) {
            ...
            try {
                ...
                state.authLoop = await withAuth(() => setupLink(consumerId, ctx, name, address, obj, state, queue, eventPosition, logger$1, options, abortSignal), ctx, audience, timeoutInMs, logger$1, {
                    abortSignal,
                });
            }
            catch (err) {
                ...
                return obj.isClosed || ctx.wasConnectionCloseCalled || eventsToRetrieveCount === 0
                    ...
                    : new Promise((resolve, reject) => {
                        ...
                        obj // eslint-disable-line promise/catch-or-return
                            ...
                            logger$1.verbose(`setting the max wait time to ${maxWaitTimeInSeconds} seconds`);
